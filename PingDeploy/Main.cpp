...
#include <PingDeploy/Top/PingDeployTopology.hpp>
...
int main(int argc, char* argv[]) {
    ...
    PingDeploy::TopologyState inputs;
    ...
    PingDeploy::setupTopology(inputs);
    PingDeploy::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    PingDeploy::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
