// ======================================================================
// \title  PingDeployTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef PINGDEPLOY_PINGDEPLOYTOPOLOGY_HPP
#define PINGDEPLOY_PINGDEPLOYTOPOLOGY_HPP
// Included for access to PingDeploy::TopologyState and PingDeploy::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <PingDeploy/Top/PingDeployTopologyDefs.hpp>

// Remove unnecessary PingDeploy:: qualifications
using namespace PingDeploy;
namespace PingDeploy {
/**
 ...
 * PingDeploy::TopologyState see: PingDeployTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type PingDeploy::TopologyState see: PingDeployTopologyDefs.hpp.
 *
