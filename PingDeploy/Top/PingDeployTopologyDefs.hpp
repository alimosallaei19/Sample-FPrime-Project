// ======================================================================
// \title  PingDeployTopologyDefs.hpp
// \brief required header file containing the required definitions for the topology autocoder
//
// ======================================================================
#ifndef PINGDEPLOY_PINGDEPLOYTOPOLOGYDEFS_HPP
#define PINGDEPLOY_PINGDEPLOYTOPOLOGYDEFS_HPP

#include "Drv/BlockDriver/BlockDriver.hpp"
#include "Fw/Types/MallocAllocator.hpp"
#include "PingDeploy/Top/FppConstantsAc.hpp"
 ...
 *
 * The topology autocoder requires an object that carries state with the name `PingDeploy::TopologyState`. Only the type
