...
#include <PingDeployServer/Top/PingDeployServerTopology.hpp>
...
static void signalHandler(int signum) {
    PingDeployServer::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    PingDeployServer::TopologyState inputs;
    ...
    PingDeployServer::setupTopology(inputs);
    PingDeployServer::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    PingDeployServer::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
