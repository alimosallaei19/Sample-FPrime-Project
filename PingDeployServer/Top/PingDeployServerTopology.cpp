// ======================================================================
// \title  PingDeployServerTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <PingDeployServer/Top/PingDeployServerTopologyAc.hpp>
#include <PingDeployServer/Top/PingDeployServerPacketsAc.hpp>
...
void configureTopology() {
    ...
    // tlmSend.setPacketList(PingDeployServerPacketsPkts, PingDeployServerPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name PingDeployServer
...
void startSimulatedCycle(U32 milliseconds) {
    ...
    // Main loop
    while (cycling) {
        PingDeployServer::blockDrv.callIsr();
