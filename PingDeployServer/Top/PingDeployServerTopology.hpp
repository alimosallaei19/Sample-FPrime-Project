// ======================================================================
// \title  PingDeployServerTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef PINGDEPLOYSERVER_PINGDEPLOYSERVERTOPOLOGY_HPP
#define PINGDEPLOYSERVER_PINGDEPLOYSERVERTOPOLOGY_HPP
// Included for access to PingDeployServer::TopologyState and PingDeployServer::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <PingDeployServer/Top/PingDeployServerTopologyDefs.hpp>

// Remove unnecessary PingDeployServer:: qualifications
using namespace PingDeployServer;
namespace PingDeployServer {
/**
 ...
 * PingDeployServer::TopologyState see: PingDeployServerTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type PingDeployServer::TopologyState see: PingDeployServerTopologyDefs.hpp.
 *
